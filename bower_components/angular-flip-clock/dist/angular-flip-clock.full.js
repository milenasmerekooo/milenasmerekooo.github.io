...
angular.module('dyFlipClock').run(['$templateCache', function($templateCache) {
  $templateCache.put('src/js/angular-flip-clock-directive/angular-flip-clock-directive.html',
    ...
    '  <dy-flip-clock-label text="Часы" hide-divider="true"></dy-flip-clock-label>\n' +
    ...
    '\n' +
    '  <dy-flip-clock-label text="Минуты"></dy-flip-clock-label>\n' +
    ...
    '\n' +
    '  <dy-flip-clock-label text="Секунды"></dy-flip-clock-label>\n' +
